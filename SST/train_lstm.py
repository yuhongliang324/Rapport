...
def train(drop=0., hidden_dim=None, lamb=0.0001, batch_size=32, num_epoch=10):
    ...
    model = LSTM(input_dim, hidden_dim, [num_class], drop=drop, lamb=lamb)
...
def test1():
    ...
    train(drop=args.drop, hidden_dim=args.hid, lamb=args.lamb, num_epoch=args.epoch)
